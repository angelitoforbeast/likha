<x-layout>
    <x-slot name="heading">
        Edit GSheet Settings
    </x-slot>

    <div class="bg-white p-6 rounded shadow-md w-full max-w-xl mx-auto mt-6">
        <form method="POST" action="{{ url('/import_gsheet/settings') }}" class="space-y-4">
            @csrf
            ...
            <div>
                <label for="range" class="block text-sm font-medium text-gray-700">Range (e.g. `Sheet1!A2:Z`)</label>
