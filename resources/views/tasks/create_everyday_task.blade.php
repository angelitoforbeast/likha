<x-layout>
    <x-slot name="heading">📆 Create Everyday Task</x-slot>

    <form method="POST" action="{{ route('everyday-task.store') }}" class="max-w-xl mx-auto space-y-4">
        @csrf
        ...
        <div class="text-center">
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded">Save Everyday Task</button>
        </div>
    </form>
</x-layout>
