<x-layout>
  <x-slot name="heading">Import From Google Sheets (Checker 2)</x-slot>
  ...
  {{-- Import button --}}
  <form method="POST" action="{{ url('/checker_2/gsheet/import') }}" onsubmit="return confirm('Are you sure you want to import?')">
    @csrf
