<div style="font-size:13px; margin-bottom:8px;">
  ...
  <div>Metric: <strong>{{ $metric }}</strong></div>
  <div>Group: <strong>{{ $group }}</strong></div>
  <div>Total waybills: <strong>{{ count($items) }}</strong></div>
  <div style="margin-top:4px; color:#666;">
    *Showing <strong>Submission Time</strong>, <strong>Province</strong> and <strong>FULL status_logs</strong> (all dates).
  </div>
</div>
...
<table style="border-collapse:collapse; width:100%; font-size:13px;">
  <thead>
    <tr>
      ...
      <th style="border:1px solid #ccc; padding:6px;">Province</th>
  ...
  <tbody>
    ...
    @empty
      <tr>
        <td colspan="6" style="border:1px solid #ccc; padding:8px;">No results.</td>
      </tr>
    @endforelse
  </tbody>
</table>
