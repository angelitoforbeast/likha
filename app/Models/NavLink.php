...
class NavLink extends Model
{
    ...
    public static function defaultData(): array
    {
        return [
            ...
            ['key'=>'prompt_generator',      'label'=>'Prompt Gen',         'route_url'=>'/prompt-generator',                     'icon'=>'fa-solid fa-robot',            'active_pattern'=>'prompt-generator*',              'visible'=>['Marketing','Marketing - OIC','CEO']],
