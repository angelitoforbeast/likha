...
class OwnerColumnSettingsController extends Controller
{
    ...
    public const CATALOG = [
        'owner_private' => [
            ...
            ['id' => 'np_per_order',     'label' => 'NP/O (1D)'],
            ['id' => 'np_per_order_3d',  'label' => 'NP/O (3D)'],
            ['id' => 'np_per_order_7d',  'label' => 'NP/O (7D)'],
            ['id' => 'np_per_order_1m',  'label' => 'NP/O (1M, entire range)'],
    ...
    public const DEFAULT_VISIBLE = [
        'owner_private' => [
            ...
            'tcpr', 'breakeven_cpp',
            'proj_profit', 'per_order', 'np_per_order', 'np_per_order_3d', 'np_per_order_7d', 'np_per_order_1m', 'proj_pct',
