...
Route::get   ('/gsheet_groups/history',          [\App\Http\Controllers\GsheetGroupController::class, 'history']);
Route::get   ('/gsheet_groups/deletion/{run}/status', [\App\Http\Controllers\GsheetGroupController::class, 'deletionStatus'])->whereNumber('run');
...
Route::post('/jnt/status/export-to-gsheet', [JntStatusController::class, 'exportToGsheet'])
    ...
    Route::get ('/prompt-generator/settings',      [\App\Http\Controllers\PromptGeneratorController::class, 'getSettings'])  ->name('prompt.generator.settings.get');
